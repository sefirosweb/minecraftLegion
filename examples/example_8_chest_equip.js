...
function openChest () {
  ...
  function checkImReady () {
    if (countItemsInInventoryOrEquipped('sword') == 0) { return false }
    if (countItemsInInventoryOrEquipped('shield') == 0) { return false }
    if (countItemsInInventoryOrEquipped('bow') == 0) { return false }
    if (countItemsInInventoryOrEquipped('arrow') <= 64) { return false }

    if (countItemsInInventoryOrEquipped('helmet') == 0) { return false }
    if (countItemsInInventoryOrEquipped('chest') == 0) { return false }
    if (countItemsInInventoryOrEquipped('leggings') == 0) { return false }
    if (countItemsInInventoryOrEquipped('boots') == 0) { return false }
  ...
  function withdrawItem (item, amount) {
    return new Promise((resolve, reject) => {
      ...
      const foundItem = chest.items().find(itemtoFind => itemtoFind.name.includes(item))
      if (!foundItem) {
