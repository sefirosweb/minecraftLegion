...
module.exports = {
  ...
  plants: {
    carrot: { plantName: 'carrots', type: 'normal', seed: 'carrot', age: 7, craftedBy: null, marginPlant: { x: 0, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    potato: { plantName: 'potatoes', type: 'normal', seed: 'potato', age: 7, craftedBy: null, marginPlant: { x: 0, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    beetroot: { plantName: 'beetroots', type: 'normal', seed: 'beetroot_seeds', age: 3, craftedBy: null, marginPlant: { x: 0, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    wheat: { plantName: 'wheat', type: 'normal', seed: 'wheat_seeds', age: 7, craftedBy: null, marginPlant: { x: 0, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    melon: { plantName: 'melon', type: 'melon', seed: 'melon_seeds', age: null, craftedBy: 'melon_slice', marginPlant: { x: 1, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    pumpkin: { plantName: 'pumpkin', type: 'melon', seed: 'pumpkin_seeds', age: null, craftedBy: 'pumpkin', marginPlant: { x: 1, z: 0 }, plantIn: ['farmland'], canPlantIn: dirtType.dirt },
    ...
    cactus: { plantName: 'cactus', type: 'sapling', seed: 'cactus', age: null, craftedBy: null, marginPlant: { x: 2, z: 2 }, plantIn: ['sand'], canPlantIn: ['sand'] }
  },
