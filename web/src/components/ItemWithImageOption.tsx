...
export const ItemWithImageOption: React.FC<OptionProps<ItemOption>> = (props) => (
  <components.Option {...props}>
    <div className="d-flex justify-content-between ">
      ...
      <div>
        <ItemImage name={props.data.value.name} alt={props.data.label} />
      </div>
    </div>
  </components.Option>
);

export const SingleValueWithImage: React.FC<SingleValueProps<ItemOption>> = (props) => (
