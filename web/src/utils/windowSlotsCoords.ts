const inventory: Record<number, [number, number]> = {
  // Crafting slots
  0: [307, 55],
  1: [195, 35],
  2: [231, 35],
...
const chest: Record<number, [number, number]> = {
  // Chest slots
  0: [15, 35],
  9: [15, 71],
  18: [15, 107],
...
const largeChest: Record<number, [number, number]> = {
  // Chest slots
  0: [15, 35],
  9: [15, 71],
  18: [15, 107],
...
const craftingTable: Record<number, [number, number]> = {
...
const furnace: Record<number, [number, number]> = {
  0: [111, 33], // Input slot
  1: [111, 105], // Fuel slot
