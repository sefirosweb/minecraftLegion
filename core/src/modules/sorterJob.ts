...
export const findItemsInChests = (chestInput: Chests, itemsInput: Array<Item>, exclude?: any) => {
...
export const sortChestVec = (a: ChestBlock, b: ChestBlock, sortBy: string, sort: string) => {
  let tempA = a
  let tempB = b
  if (sort === 'desc') {
    tempA = b
...
export const sortChests = (chestInput: Chests) => {
...
export const calculateSlotsToSort = (chests: Chests, newChestSort: NewChestSort) => {
